...
need to so some minor modifications. This i also a one time thing per reference, for references that have already been converted
...
cm:
- {} # Template with no user defined content  
cr:
- {}
crb:
- {}
